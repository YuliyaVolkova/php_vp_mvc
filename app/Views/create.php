...
<div class="container">
    ...
    <div class="form-container">
        <form action="/admin/store" method="post" id="regForm" enctype="multipart/form-data">
            <h2>Добавить нового пользователя</h2>
            <div class='form-mes_reg' id=formMes></div>
            <div class="form-group form-group-left-align">
                <div class="form-subgroup2-left">
                    <label for="inputName">Имя</label>
                    <input type="text" class="form-control" id="inputName" placeholder="Введите имя" name="name" required>
                </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="inputDescription" rows="2" placeholder="Добавьте описание" name="description"></textarea>
            </div>
            ...
            <div class="form-group form-group-left-align">
                <div class="form-subgroup3-left">
                    ...
                    <input type="text" class="form-control" id="inputLogin" placeholder="Введите логин" name="login" required>
                </div>
                <div class="form-subgroup3-left">
                ...
                <div class="form-subgroup3-left">
                    ...
                    <input type="password" class="form-control" id="inputPassword1" placeholder="Введите пароль" name="password" required>
                </div>
            </div>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-submit" name="submit">Добавить пользователя</button>
            </div>
        </form>
    </div>
